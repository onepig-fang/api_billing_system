			...
			case 'checkbox':
			{
				...
				if(len > 1)
				{
					...
					for(var i = 0; i < len; i++)
					{
						if(e[i]!=undefined)
						{
							if(value == e[i].value || _value.indexOf(';'+e[i].value+';') != -1 || _value.indexOf(','+e[i].value+',') != -1)
							{
								e[i].checked = true;
							}
							else
			...
			default:
			{
				...
				if (len>0)
				{
					...
					for(var j=0;j<len;j++)
					{
						if(e[j]!=undefined)
						{
							if(value==e[j].value || _value.indexOf(";"+e[j].value+";")!=-1 || _value.indexOf(","+e[j].value+",")!=-1)e[j].checked=true;
						}
					}
				}
				break;
