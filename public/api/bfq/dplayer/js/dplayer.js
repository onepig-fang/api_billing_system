!function(e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define("straydmplayer", [], t) : "object" == typeof exports ? exports.straydmplayer = t() : e.straydmplayer = t()
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            var t = ""
              ...
              , u = e.url
              , n = a && "webvtt" === a.type;
            return t += '\n<video\n id="straydmvideo"\n    class="straydmplayer-video ',
            o && (t += "straydmplayer-video-current"),
        ...
        var o = function() {
          ...
          , Y = function() {
            function e(t) {
                ...
                this.container.classList.add("straydmplayer"),
                this.options.danmaku || this.container.classList.add("straydmplayer-no-danmaku"),
                this.options.live && this.container.classList.add("straydmplayer-live"),
                c.default.isMobile && this.container.classList.add("straydmplayer-mobile"),
                this.arrow = this.container.offsetWidth <= 500,
                this.arrow && this.container.classList.add("straydmplayer-arrow"),
            ...
            return o(e, [{
                ...
                value: function() {
                    ...
                    this.container.classList.remove("straydmplayer-paused"),
                    this.container.classList.add("straydmplayer-playing"),
                ...
                value: function() {
                    this.paused = !0,
                    this.container.classList.remove("straydmplayer-loading"),
                    ...
                    this.container.classList.remove("straydmplayer-playing"),
                    this.container.classList.add("straydmplayer-paused"),
                        ...
                        case "webtorrent":
                            if (WebTorrent)
                                if (WebTorrent.WEBRTC_SUPPORT) {
                                    this.container.classList.add("straydmplayer-loading");
                                    ...
                                    o.add(s, function(e) {
                                        e.files.find(function(e) {
                                            ...
                                            n.container.classList.remove("straydmplayer-loading")
                                        })
                                    })
                                } else
                    ...
                    if (this.qualityIndex !== e && !this.switchingQuality) {
                        ...
                        this.on("canplay", function() {
                            if (t.prevVideo) {
                                ...
                                t.video.classList.add("straydmplayer-video-current"),
                                n || t.video.play(),
                                t.prevVideo = null,
    ...
    , function(e, t, n) {
        ...
        t.default = function(e) {
            var t = {
                container: e.element || document.getElementsByClassName("straydmplayer")[0],
                live: !1,
                autoplay: !1,
                theme: "#b7daff",
                loop: !1,
    ...
    , function(e, t, n) {
        ...
        var a = {
            "zh-cn": {
                ...
                "About author": "关于作者",
                "straydmplayer feedback": "播放器意见反馈",
            ...
            "zh-tw": {
                ...
                "About author": "關於作者",
                "straydmplayer feedback": "播放器意見反饋",
          ...
          , u = function() {
            ...
            return o(e, [{
                ...
                value: function() {
                    ...
                    this.volumeBar = this.container.querySelector(".straydmplayer-volume-bar-inner"),
                    this.volumeBarWrap = this.container.querySelector(".straydmplayer-volume-bar"),
                    this.volumeBarWrapWrap = this.container.querySelector(".straydmplayer-volume-bar-wrap"),
                    this.volumeButton = this.container.querySelector(".straydmplayer-volume"),
                    this.volumeIcon = this.container.querySelector(".straydmplayer-volume-icon .straydmplayer-icon-content"),
                    this.playedBar = this.container.querySelector(".straydmplayer-played"),
                    this.loadedBar = this.container.querySelector(".straydmplayer-loaded"),
                    this.playedBarWrap = this.container.querySelector(".straydmplayer-bar-wrap"),
                    this.playedBarTime = this.container.querySelector(".straydmplayer-bar-time"),
                    this.danmaku = this.container.querySelector(".straydmplayer-danmaku"),
                    this.danmakuLoading = this.container.querySelector(".straydmplayer-danloading"),
                    this.video = this.container.querySelector(".straydmplayer-video-current"),
                    this.bezel = this.container.querySelector(".straydmplayer-bezel-icon"),
                    this.playButton = this.container.querySelector(".straydmplayer-play-icon"),
                    this.videoWrap = this.container.querySelector(".straydmplayer-video-wrap"),
                    this.controllerMask = this.container.querySelector(".straydmplayer-controller-mask"),
                    this.ptime = this.container.querySelector(".straydmplayer-ptime"),
                    this.settingButton = this.container.querySelector(".straydmplayer-setting-icon"),
                    this.settingBox = this.container.querySelector(".straydmplayer-setting-box"),
                    this.mask = this.container.querySelector(".straydmplayer-mask"),
                    this.loop = this.container.querySelector(".straydmplayer-setting-loop"),
                    this.loopToggle = this.container.querySelector(".straydmplayer-setting-loop .straydmplayer-toggle-setting-input"),
                    this.showDanmaku = this.container.querySelector(".straydmplayer-setting-showdan"),
                    this.showDanmakuToggle = this.container.querySelector(".straydmplayer-showdan-setting-input"),
                    this.unlimitDanmaku = this.container.querySelector(".straydmplayer-setting-danunlimit"),
                    this.unlimitDanmakuToggle = this.container.querySelector(".straydmplayer-danunlimit-setting-input"),
                    this.speed = this.container.querySelector(".straydmplayer-setting-speed"),
                    this.speedItem = this.container.querySelectorAll(".straydmplayer-setting-speed-item"),
                    this.danmakuOpacityBar = this.container.querySelector(".straydmplayer-danmaku-bar-inner"),
                    this.danmakuOpacityBarWrap = this.container.querySelector(".straydmplayer-danmaku-bar"),
                    this.danmakuOpacityBarWrapWrap = this.container.querySelector(".straydmplayer-danmaku-bar-wrap"),
                    this.danmakuOpacityBox = this.container.querySelector(".straydmplayer-setting-danmaku"),
                    this.dtime = this.container.querySelector(".straydmplayer-dtime"),
                    this.controller = this.container.querySelector(".straydmplayer-controller"),
                    this.commentInput = this.container.querySelector(".straydmplayer-comment-input"),
                    this.commentButton = this.container.querySelector(".straydmplayer-comment-icon"),
                    this.straydmcomment = this.container.querySelector(".straydm-straydmplayer-comment-input"),
                    this.commentSettingBox = this.container.querySelector(".straydmplayer-comment-setting-box"),
                    this.commentSettingButton = this.container.querySelector(".straydmplayer-comment-setting-icon"),
                    this.commentSettingFill = this.container.querySelector(".straydmplayer-comment-setting-icon path"),
                    this.commentSendButton = this.container.querySelector(".straydmplayer-send-icon"),
                    this.commentSendFill = this.container.querySelector(".straydmplayer-send-icon path"),
                    this.commentColorSettingBox = this.container.querySelector(".straydmplayer-comment-setting-color"),
                    this.browserFullButton = this.container.querySelector(".straydmplayer-full-icon"),
                    this.webFullButton = this.container.querySelector(".straydmplayer-full-in-icon"),
                    this.menu = this.container.querySelector(".straydmplayer-menu"),
                    this.menuItem = this.container.querySelectorAll(".straydmplayer-menu-item"),
                    this.qualityList = this.container.querySelector(".straydmplayer-quality-list"),
                    this.camareButton = this.container.querySelector(".straydmplayer-camera-icon"),
                    this.subtitleButton = this.container.querySelector(".straydmplayer-subtitle-icon"),
                    this.subtitleButtonInner = this.container.querySelector(".straydmplayer-subtitle-icon .straydmplayer-icon-content"),
                    this.subtitle = this.container.querySelector(".straydmplayer-subtitle"),
                    this.qualityButton = this.container.querySelector(".straydmplayer-quality-icon"),
                    this.barPreview = this.container.querySelector(".straydmplayer-bar-preview"),
                    this.barWrap = this.container.querySelector(".straydmplayer-bar-wrap"),
                    this.notice = this.container.querySelector(".straydmplayer-notice"),
                    this.infoPanel = this.container.querySelector(".straydmplayer-info-panel"),
                    this.infoPanelClose = this.container.querySelector(".straydmplayer-info-panel-close"),
                    this.infoVersion = this.container.querySelector(".straydmplayer-info-panel-item-version .straydmplayer-info-panel-item-data"),
                    this.infoFPS = this.container.querySelector(".straydmplayer-info-panel-item-fps .straydmplayer-info-panel-item-data"),
                    this.infoType = this.container.querySelector(".straydmplayer-info-panel-item-type .straydmplayer-info-panel-item-data"),
                    this.infoUrl = this.container.querySelector(".straydmplayer-info-panel-item-url .straydmplayer-info-panel-item-data"),
                    this.infoResolution = this.container.querySelector(".straydmplayer-info-panel-item-resolution .straydmplayer-info-panel-item-data"),
                    this.infoDuration = this.container.querySelector(".straydmplayer-info-panel-item-duration .straydmplayer-info-panel-item-data"),
                    this.infoDanmakuId = this.container.querySelector(".straydmplayer-info-panel-item-danmaku-id .straydmplayer-info-panel-item-data"),
                    this.infoDanmakuApi = this.container.querySelector(".straydmplayer-info-panel-item-danmaku-api .straydmplayer-info-panel-item-data"),
                    this.infoDanmakuAmount = this.container.querySelector(".straydmplayer-info-panel-item-danmaku-amount .straydmplayer-info-panel-item-data")
                }
            }]),
            e
        }();
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            e.$value,
            e.$index;
            return t += '<div class="straydmplayer-mask"></div><div class="fixed"></div><div id="straydmzdy" class="straydmzdycss"></div>\n<div class="straydmplayer-cplayer"><div class="straydmplayer-showing"><svg aria-hidden="true"><use xlink:href="#icon-play"></use></svg></div><div class="vod-title"><div id="landing-title" class="video-info"><ul class="u-title"><a id="vodlink" href="" target="_blank" ><span class="iconfont icon-back"></span></a><a id="vodtitle"><span></span></a></ul></div></div></div><div class="straydmplayer-video-wrap">\n    ',
            function(e) {
                t += e
            }(n(4)(a)),
            t += "\n    ",
            o.logo && (t += '\n    <div class="straydmplayer-logo">\n        <img src="',
            t += s(o.logo),
            t += '">\n    </div>\n    '),
            t += '\n    <div class="straydmplayer-danmaku"',
            o.danmaku && o.danmaku.bottm && (t += ' style="margin-bottom:',
            t += s(o.danmaku.bottm),
            t += '"'),
            t += '>\n        <div class="straydmplayer-danmaku-item straydmplayer-danmaku-item--demo"></div>\n    </div>\n    <div class="straydmplayer-subtitle"></div>\n    <div class="straydmplayer-bezel">\n        <span class="straydmplayer-bezel-icon"></span>\n        ',
            o.danmaku && (t += '\n        <span class="straydmplayer-danloading">',
            t += "</span>\n        "),
            t += '\n        <span class="diplayer-loading-icon">',
            t += l.loading,
            t += '</span>\n    </div>\n</div>\n<div class="straydmplayer-controller-mask"></div>\n<div class="straydmplayer-controller">\n  <div class="controller-box">\n   <div class="straydmplayer-icons straydmplayer-icons-left">\n        <button class="straydmplayer-icon straydmplayer-play-icon" id="bofang">\n            <span class="straydmplayer-icon-content">',
            t += l.play,
            t += '</span>\n        </button>\n    <button onclick="stray.next();" class="straydmplayer-icon  icon-xj" data-balloon="下一集" data-balloon-pos="up">\n<span class="straydmplayer-icon-content"><svg aria-hidden="true" fill="#fff"><use xlink:href="#icon-play-xj"></use></svg></span></button>\n    <div class="straydmplayer-volume">\n            <button class="straydmplayer-icon straydmplayer-volume-icon">\n                <span class="straydmplayer-icon-content">',
            t += l.volumeDown,
            t += '</span>\n            </button>\n            <div class="straydmplayer-volume-bar-wrap" data-balloon-pos="up">\n                <div class="straydmplayer-volume-bar">\n                    <div class="straydmplayer-volume-bar-inner" style="background: ',
            t += s(o.theme),
            t += ';">\n                        <span class="straydmplayer-thumb" style="background: ',
            t += s(o.theme),
            t += '"></span>\n                    </div>\n                </div>\n            </div>\n        </div>\n        <span class="straydmplayer-time">\n            <span class="straydmplayer-ptime">0:00</span> /\n            <span class="straydmplayer-dtime">0:00</span>\n        </span>\n        ',
            o.live && (t += '\n        <span class="straydmplayer-live-badge"><span class="straydmplayer-live-dot" style="background: ',
            t += s(o.theme),
            t += ';"></span>',
            t += s(r("Live")),
            t += "</span>\n        "),
            t += '\n    </div>\n    <div class="straydmplayer-icons straydmplayer-icons-right">\n        ',
            o.video.quality && (t += '\n        <div class="straydmplayer-quality">\n            <button class="straydmplayer-icon straydmplayer-quality-icon">',
            t += s(o.video.quality[o.video.defaultQuality].name),
            t += '</button>\n            <div class="straydmplayer-quality-mask">\n                <div class="straydmplayer-quality-list"></div>\n                ',
            u(o.video.quality, function(e, n) {
                t += '\n                    <div class="straydmplayer-quality-item" data-index="',
                t += s(n),
                t += '">',
                t += s(e.name),
                t += "</div>\n                "
            ...
            t += '" value="bottom">\n                    <span>',
            t += s(r("Bottom")),
            t += '</span>\n                </label>\n            </div>\n    <div class="straydmplayer-comment-setting-font"><div class="straydmplayer-comment-setting-title">弹幕大小</div><label><input type="radio"name="straydmplayer-danmaku-font-0"value="50px"><span>超大</span></label><label><input type="radio"name="straydmplayer-danmaku-font-0"value="30px"><span>较大</span></label><label><input type="radio"name="straydmplayer-danmaku-font-0"value="25px"checked=""><span>标准</span></label><label><input type="radio"name="straydmplayer-danmaku-font-0"value="18px"><span>较小</span></label></div>      <div class="straydmplayer-comment-setting-color">\n                <div class="straydmplayer-comment-setting-title">',
            t += s(r("Set danmaku color")),
            t += '</div>\n                <label>\n                    <input type="radio" name="straydmplayer-danmaku-color-',
            t += s(c),
            ...
            t += s(c),
            t += '" value="#FFFFFF" checked>\n                    <span style="background: #FFFFFF"></span>\n                </label>\n</div>\n                   </div>\n        <input class="straydmplayer-comment-input" type="text" placeholder="',
            t += s(r("Input danmaku, hit Enter")),
            t += '" maxlength="30">\n        <button class="straydmplayer-icon straydmplayer-send-icon" data-balloon="',
            t += s(r("Send")),
            t += '" data-balloon-pos="up">\n            <span class="straydmplayer-icon-content">',
            t += l.send,
            t += '</span>\n        </button>\n<input id="dmtext" dmtype="right" size="27.5px" class="straydm-straydmplayer-comment-input" type="text" placeholder="',
            t += s(r("Input danmaku, hit Enter")),
            t += '" maxlength="30" autocomplete="off" >\n        <button class="straydmplayer-icon straydm-straydmplayer-send-icon"  data-balloon-pos="up">发送	</button>\n   </div>\n  </div>\n<div class="straydmplayer-info-panel straydmplayer-info-panel-hide">\n    <div class="straydmplayer-info-panel-close">关闭</div>\n    <div class="straydmplayer-info-panel-item straydmplayer-info-panel-item-version">\n        <span class="straydmplayer-info-panel-item-title">播放器版本</span>\n        <span class="straydmplayer-info-panel-item-data"></span>\n    </div>\n    <div class="straydmplayer-info-panel-item straydmplayer-info-panel-item-fps">\n        <span class="straydmplayer-info-panel-item-title">播放器帧率</span>\n        <span class="straydmplayer-info-panel-item-data"></span>\n    </div>\n    <div class="straydmplayer-info-panel-item straydmplayer-info-panel-item-type">\n        <span class="straydmplayer-info-panel-item-title">视频类型</span>\n        <span class="straydmplayer-info-panel-item-data"></span>\n    </div>\n    <div class="straydmplayer-info-panel-item straydmplayer-info-panel-item-url">\n        <span class="straydmplayer-info-panel-item-title">视频地址</span>\n        <span class="straydmplayer-info-panel-item-data"></span>\n    </div>\n    <div class="straydmplayer-info-panel-item straydmplayer-info-panel-item-resolution">\n        <span class="straydmplayer-info-panel-item-title">视频分辨率</span>\n        <span class="straydmplayer-info-panel-item-data"></span>\n    </div>\n    <div class="straydmplayer-info-panel-item straydmplayer-info-panel-item-duration">\n        <span class="straydmplayer-info-panel-item-title">视频时长</span>\n        <span class="straydmplayer-info-panel-item-data"></span>\n    </div>\n    ',
            o.danmaku && (t += '\n    <div class="straydmplayer-info-panel-item straydmplayer-info-panel-item-danmaku-id">\n        <span class="straydmplayer-info-panel-item-title">弹幕 ID</span>\n        <span class="straydmplayer-info-panel-item-data"></span>\n    </div>\n    <div class="straydmplayer-info-panel-item straydmplayer-info-panel-item-danmaku-api">\n        <span class="straydmplayer-info-panel-item-title">弹幕API</span>\n        <span class="straydmplayer-info-panel-item-data"></span>\n    </div>\n    <div class="straydmplayer-info-panel-item straydmplayer-info-panel-item-danmaku-amount">\n        <span class="straydmplayer-info-panel-item-title">弹幕数量</span>\n        <span class="straydmplayer-info-panel-item-data"></span>\n    </div>\n<div class="straydmplayer-info-panel-item straydmplayer-info-panel-item-title-amount"><span class="straydmplayer-info-panel-item-title">视频标题</span><span class="straydmplayer-info-panel-item-data" id="vod-title"></span></div>\n    '),
            t += '\n</div>\n<div class="straydmplayer-menu">\n    ',
            u(o.contextmenu, function(e, n) {
                t += '\n        <div class="straydmplayer-menu-item">\n            <a target="',
                t += s(e.tzym || "_self"),
                t += '" href="',
          ...
          , s = function() {
            ...
            return o(e, [{
                ...
                value: function() {
                    var e = this
                      , t = void 0;
                    t = this.options.api.maximum ? this.options.api.address + config.url + "&max=" + this.options.api.maximum : this.options.api.address  + config.url;
                ...
                value: function(e) {
                    if (void 0 !== e) {
                        for (var t = this.container.getElementsByClassName("straydmplayer-danmaku-item"), n = 0; n < t.length; n++)
                            t[n].style.opacity = e;
                        this._opacity = e,
                    ...
                    if (this.showing) {
                        ...
                        for (var u = document.createDocumentFragment(), d = 0; d < e.length; d++)
                            !function(a) {
                                ...
                                o.classList.add("straydmplayer-danmaku-item"),
                                o.classList.add("straydmplayer-danmaku-" + e[a].type),
                                ...
                                r >= 0 && (o.classList.add("straydmplayer-danmaku-move"),
                                u.appendChild(o))
                            }(d);
                ...
                value: function(e) {
                    if (!this.context) {
                        var t = getComputedStyle(this.container.getElementsByClassName("straydmplayer-danmaku-item")[0], null);
                ...
                key: "resize",
                value: function() {
                    for (var e = this.container.offsetWidth, t = this.container.getElementsByClassName("straydmplayer-danmaku-item"), n = 0; n < t.length; n++)
          ...
          , r = function() {
            ...
            return a(e, [{
                ...
                value: function() {
                    ...
                    case "web":
                        return this.player.container.classList.contains("straydmplayer-fulled")
                    }
                }
            }, {
                key: "request",
                    ...
                    case "web":
                        ...
                        if (document.pictureInPictureEnabled == true) {
                            if (document.getElementById('enterhzh') != null) {
                                ...
                                // 进入画中画模式时候执行
                                straydmvideo.addEventListener('enterpictureinpicture', function() {
                                    $('head').append('<style>.fixed{height:0%;}</style>');
                                });
                                straydmvideo.addEventListener('leavepictureinpicture', function() {
                                    $('head').append('<style>.fixed{height:' + stray.pmdzd + ';}</style>');
                                });
                            }
                        } else {
        ...
        var a = function() {
          ...
          , r = function() {
            function e(t) {
                i(this, e),
                this.storageName = {
                    opacity: "straydmplayer-danmaku-opacity",
                    volume: "straydmplayer-volume",
                    unlimited: "straydmplayer-danmaku-unlimited",
                    danmaku: "straydmplayer-danmaku-show",
                    subtitle: "straydmplayer-subtitle-show"
                },
                this.default = {
                    opacity: .7,
        ...
        var a = function() {
          ...
          , o = function() {
            ...
            return a(e, [{
                ...
                key: "show",
                value: function() {
                    this.container.classList.remove("straydmplayer-subtitle-hide"),
                    this.events.trigger("subtitle_show")
                }
            }, {
                key: "hide",
                value: function() {
                    this.container.classList.add("straydmplayer-subtitle-hide"),
                    this.events.trigger("subtitle_hide")
                }
            }, {
                key: "toggle",
                value: function() {
                    this.container.classList.contains("straydmplayer-subtitle-hide") ? this.show() : this.hide()
                }
            }]),
            e
        }();
            ...
            return a(e, [{
                ...
                value: function() {
                    ...
                    this.loadingChecker = setInterval(function() {
                        ...
                        i || n !== t || e.player.video.paused || (e.player.container.classList.add("straydmplayer-loading"),
                        i = !0),
                        i && n > t && !e.player.video.paused && (e.player.container.classList.remove("straydmplayer-loading"),
                        i = !1),
                        t = n)
                    }, 100)
                }
          ...
          , o = function() {
            function e(t) {
                ...
                this.container.addEventListener("animationend", function() {
                    n.container.classList.remove("straydmplayer-bezel-transition")
                })
            }
            return a(e, [{
                key: "switch",
                value: function(e) {
                    ...
                    this.container.classList.add("straydmplayer-bezel-transition")
                }
            }]),
            e
        }();
            ...
            return o(e, [{
                ...
                value: function() {
                    var e = this
                      ...
                      , n = function n() {
                        document.removeEventListener(r.default.nameMap.dragEnd, n),
                        document.removeEventListener(r.default.nameMap.dragMove, t),
                        e.player.template.volumeButton.classList.remove("straydmplayer-volume-active")
                    };
                    ...
                    this.player.template.volumeBarWrapWrap.addEventListener(r.default.nameMap.dragStart, function() {
                        document.addEventListener(r.default.nameMap.dragMove, t),
                        document.addEventListener(r.default.nameMap.dragEnd, n),
                        e.player.template.volumeButton.classList.add("straydmplayer-volume-active")
                    }),
                ...
                value: function() {
                    ...
                    this.player.options.video.quality && this.player.template.qualityList.addEventListener("click", function(t) {
                        t.target.classList.contains("straydmplayer-quality-item") && e.player.switchQuality(t.target.dataset.index)
                    })
                }
            }, {
                ...
                key: "show",
                value: function() {
                    this.player.container.classList.remove("straydmplayer-hide-controller")
                }
            }, {
                key: "hide",
                value: function() {
                    this.player.container.classList.add("straydmplayer-hide-controller"),
                ...
                key: "isShow",
                value: function() {
                    return !this.player.container.classList.contains("straydmplayer-hide-controller")
                }
            }, {
                key: "toggle",
                value: function() {
          ...
          , r = function() {
            function e(t) {
                ...
                this.player.template.speed.addEventListener("click", function() {
                    n.player.template.settingBox.classList.add("straydmplayer-setting-box-narrow"),
                    n.player.template.settingBox.classList.add("straydmplayer-setting-box-speed")
                });
                ...
                if (this.player.danmaku) {
                    ...
                    var o = function(e) {
                      ...
                      , r = function e() {
                        ...
                        n.player.template.danmakuOpacityBox.classList.remove("straydmplayer-setting-danmaku-active")
                    };
                    ...
                    this.player.template.danmakuOpacityBarWrapWrap.addEventListener(s.default.nameMap.dragStart, function() {
                        ...
                        n.player.template.danmakuOpacityBox.classList.add("straydmplayer-setting-danmaku-active")
                    })
                }
            }
            return a(e, [{
                ...
                value: function() {
                    var e = this;
                    this.player.template.settingBox.classList.remove("straydmplayer-setting-box-open"),
                    this.player.template.mask.classList.remove("straydmplayer-mask-show"),
                    setTimeout(function() {
                        e.player.template.settingBox.classList.remove("straydmplayer-setting-box-narrow"),
                        e.player.template.settingBox.classList.remove("straydmplayer-setting-box-speed")
                    }, 300),
                ...
                key: "show",
                value: function() {
                    this.player.template.settingBox.classList.add("straydmplayer-setting-box-open"),
                    this.player.template.mask.classList.add("straydmplayer-mask-show"),
        ...
        var a = function() {
          ...
          , o = function() {
            function e(t) {
                ...
                this.player.template.straydmcomment.addEventListener("click", function() {
                    n.show()
                }),
            ...
            return a(e, [{
                ...
                value: function() {
                    this.player.controller.disableAutoHide = !0,
                    this.player.template.controller.classList.add("straydmplayer-controller-comment"),
                    this.player.template.mask.classList.add("straydmplayer-mask-show"),
                    this.player.container.classList.add("straydmplayer-show-controller"),
                    this.player.template.commentInput.focus()
                }
            }, {
                key: "hide",
                value: function() {
                    this.player.template.controller.classList.remove("straydmplayer-controller-comment"),
                    this.player.template.mask.classList.remove("straydmplayer-mask-show"),
                    this.player.container.classList.remove("straydmplayer-show-controller"),
                    this.player.controller.disableAutoHide = !1,
                    this.hideSetting()
                }
            }, {
                key: "showSetting",
                value: function() {
                    this.player.template.commentSettingBox.classList.add("straydmplayer-comment-setting-open")
                }
            }, {
                key: "hideSetting",
                value: function() {
                    this.player.template.commentSettingBox.classList.remove("straydmplayer-comment-setting-open")
                }
            }, {
                key: "toggleSetting",
                value: function() {
                    this.player.template.commentSettingBox.classList.contains("straydmplayer-comment-setting-open") ? this.hideSetting() : this.showSetting()
                }
            }, {
                key: "send",
                value: function() {
                    ...
                    this.player.danmaku.send({
                        ...
                        color: this.player.container.querySelector(".straydmplayer-comment-setting-color input:checked").value,
                        type: this.player.container.querySelector(".straydmplayer-comment-setting-type input:checked").value,
                        size: this.player.container.querySelector(".straydmplayer-comment-setting-font input:checked").value
                    }, function() {
        ...
        var o = function() {
          ...
          , s = function() {
            ...
            return o(e, [{
                key: "show",
                value: function(e, t) {
                    this.player.template.menu.classList.add("straydmplayer-menu-show");
                ...
                value: function() {
                    this.player.template.mask.classList.remove("straydmplayer-mask-show"),
                    this.player.template.menu.classList.remove("straydmplayer-menu-show"),
          ...
          , o = function() {
            ...
            return a(e, [{
                ...
                value: function() {
                    ...
                    this.container.classList.remove("straydmplayer-info-panel-hide")
                }
            }, {
                key: "hide",
                value: function() {
                    ...
                    this.container.classList.add("straydmplayer-info-panel-hide")
                }
            }, {
                key: "triggle",
                value: function() {
                    this.container.classList.contains("straydmplayer-info-panel-hide") ? this.show() : this.hide()
                }
            }, {
                key: "update",
                value: function() {
                    ...
                    this.template.infoVersion.innerHTML = '8.8.8',
