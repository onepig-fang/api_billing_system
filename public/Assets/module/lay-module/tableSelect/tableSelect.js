layui.define(['table', 'jquery', 'form'], function (exports) {
    ...
    tableSelect.prototype.render = function (opt) {
        ...
        //默认设置
        opt.searchKey = opt.searchKey || 'keyword'; //搜索输入框的name值 默认keyword
        opt.searchPlaceholder = opt.searchPlaceholder || '关键词搜索';//搜索输入框的提示文字 默认关键词搜索
        opt.checkedKey = opt.checkedKey || '';//表格的唯一建值，非常重要，影响到选中状态 必填
