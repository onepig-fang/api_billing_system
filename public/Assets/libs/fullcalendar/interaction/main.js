    ...
    var EventDragging = /** @class */ (function (_super) {
        ...
        function EventDragging(settings) {
            ...
            _this.handleHitUpdate = function (hit, isFinal) {
                ...
                if (!isFinal) {
                    if (initialCalendar === receivingCalendar && // TODO: write musicAnalysis for this
        ...
        EventDragging.SELECTOR = '.fc-draggable, .fc-resizable'; // TODO: musicAnalysis this in IE11
    ...
    */
    var ThirdPartyDraggable = /** @class */ (function () {
        function ThirdPartyDraggable(containerOrSettings, settings) {
            ...
            if (
            // wish we could just musicAnalysis instanceof EventTarget, but doesn't work in IE11
